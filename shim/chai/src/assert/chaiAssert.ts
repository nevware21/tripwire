...
function _createChaiAssert(): IChaiAssert {
    ...
    const chaiAssertFuncs: ChaiAssertClassFuncs = {
        ...
        deepProperty: { scopeFn: createExprAdapter("deep.property"), nArgs: 2 },
        notDeepProperty: { scopeFn: createExprAdapter("not.deep.property"), nArgs: 2 },
        ...
        sameMembers: { scopeFn: createExprAdapter("include.sameMembers"), nArgs: 2 },
        notSameMembers: { scopeFn: createExprAdapter("not.include.sameMembers"), nArgs: 2 },
        sameDeepMembers: { scopeFn: createExprAdapter("deep.include.sameMembers"), nArgs: 2 },
        notSameDeepMembers: { scopeFn: createExprAdapter("not.deep.include.sameMembers"), nArgs: 2 },
        sameOrderedMembers: { scopeFn: createExprAdapter("include.sameOrderedMembers"), nArgs: 2 },
        notSameOrderedMembers: { scopeFn: createExprAdapter("not.include.sameOrderedMembers"), nArgs: 2 },
        sameDeepOrderedMembers: { scopeFn: createExprAdapter("deep.include.sameOrderedMembers"), nArgs: 2 },
        notSameDeepOrderedMembers: { scopeFn: createExprAdapter("not.deep.include.sameOrderedMembers"), nArgs: 2 },

        includeOrderedMembers: { scopeFn: createExprAdapter("includes.startsWithMembers"), nArgs: 2 },
        notIncludeOrderedMembers: { scopeFn: createExprAdapter("not.includes.startsWithMembers"), nArgs: 2 },
        includeDeepOrderedMembers: { scopeFn: createExprAdapter("deep.includes.startsWithMembers"), nArgs: 2 },
        notIncludeDeepOrderedMembers: { scopeFn: createExprAdapter("not.deep.includes.startsWithMembers"), nArgs: 2 },
        ...
        changes: { scopeFn: createExprAdapter("change"), nArgs: 3 },
        changesBy: { scopeFn: createExprAdapter("changeBy"), nArgs: 4 },
        ...
        increasesButNotBy: { scopeFn: createExprAdapter("increasesButNotBy"), nArgs: 4 },

        decreases: { scopeFn: createExprAdapter("decrease"), nArgs: 3 },
        decreasesBy: { scopeFn: createExprAdapter("decreaseBy"), nArgs: 4 },
        doesNotDecrease: { scopeFn: createExprAdapter("not.decrease"), nArgs: 3 },
