...
describe("assert", function () {
    ...
    it("include", function() {
        ...
        "blah: argument true (\"boolean\") is not a supported collection type for the operation"
        );

        err(function () {
            assert.include(42, "bar" as any);
        },
        "argument 42 (\"number\") is not a supported collection type for the operation"
        );
    ...
    it("notInclude", function () {
        ...
        }, "blah: not expected [{a:1},{b:2}] to include {a:1}");

        err(function () {
            var obj1 = {a: 1}
                , obj2 = {b: 2};
            assert.notInclude({foo: obj1, bar: obj2}, {foo: obj1, bar: obj2}, "blah");
        }, "blah: not expected {foo:{a:1},bar:{b:2}} to include {foo:{a:1},bar:{b:2}}");
    ...
    it("deepInclude and notDeepInclude", function () {
        ...
        }, "not expected [{a:1},{b:2}] to deep include {a:1}");

        err(function () {
            assert.deepInclude({foo: obj1, bar: obj2}, {foo: {a: 1}, bar: {b: 9}}, "blah");
        }, "blah: expected {foo:{a:1},bar:{b:2}} to deep include {foo:{a:1},bar:{b:9}}");

        err(function () {
            assert.notDeepInclude({foo: obj1, bar: obj2}, {foo: {a: 1}, bar: {b: 2}}, "blah");
        }, "blah: not expected {foo:{a:1},bar:{b:2}} to deep include {foo:{a:1},bar:{b:2}}");
    });
    ...
    it("ownInclude and notOwnInclude", function() {
        ...
        }, "blah: expected {a:1} to have own properties matching {a:3}");

        err(function () {
            assert.ownInclude({a: 1}, {"toString": Object.prototype.toString});
        }, "expected {a:1} to have own properties matching {toString:");

        err(function () {
            assert.notOwnInclude({a: 1}, {a: 1}, "blah");
        }, "blah: not expected {a:1} to have own properties matching {a:1}");
    });
    ...
    it("deepOwnInclude and notDeepOwnInclude", function() {
        ...
        }, "blah: expected {a:{b:2}} to have own properties deeply matching {a:{c:3}}");

        err(function () {
            assert.deepOwnInclude({a: {b: 2}}, {"toString": Object.prototype.toString});
        }, "expected {a:{b:2}} to have own properties deeply matching {toString:");

        err(function () {
            assert.notDeepOwnInclude({a: {b: 2}}, {a: {b: 2}}, "blah");
        }, "blah: not expected {a:{b:2}} to have own properties deeply matching {a:{b:2}}");
    });
    ...
    it("keys(array|Object|arguments)", function(){
        ...
        }, "expected all keys: [\"foo\"], missing: [\"foo\"], found: [{foo:1}]");

        err(function(){
            assert.containsAllDeepKeys(new Map([[{foo: 1}, "bar"]]), { iDoNotExist: 0 });
        }, "expected all deep keys: [{iDoNotExist:0}], missing: [{iDoNotExist:0}], found: [{foo:1}]");
        ...
        }, "blah: not expected any key: [\"foo\",\"baz\"], found: [\"foo\",\"bar\"]");
    ...
    it("sameMembers", function() {
        ...
        }, "blah: expected {} to be an array-like or sized iterable");

        err(function () {
            assert.sameMembers([], {} as any, "blah");
        }, "blah: expected argument ({}) to be an array-like or sized iterable");
    });
    ...
    it("notSameMembers", function() {
        ...
        }, "blah: not expected [1,2,3] to have the same members as [2,1,3]");
    });
    ...
    it("sameDeepMembers", function() {
        ...
        }, "blah: expected [{b:3}] to have the same deeply equal members as [{c:3}]");

        err(function() {
            assert.sameDeepMembers([ {b: 3} ], [ {b: 5} ]);
        }, "expected [{b:3}] to have the same deeply equal members as [{b:5}]");
    });
    ...
    it("notSameDeepMembers", function() {
        ...
        }, "blah: not expected [{a:1},{b:2},{c:3}] to have the same deeply equal members as [{b:2},{a:1},{c:3}]");
    });
    ...
    it("notSameOrderedMembers", function() {
        ...
        }, "blah: not expected [1,2,3] to have the same ordered members as [1,2,3]");
    });
    ...
    it("notSameDeepOrderedMembers", function() {
        ...
        }, "blah: not expected [{a:1},{b:2},{c:3}] to have the same ordered members as [{a:1},{b:2},{c:3}]");
    });
    ...
    it("includeDeepMembers", function() {
        ...
        }, "expected [{a:1},{b:2},{c:3}] to include deep members [{c:3},{c:3}]");

        err(function() {
            assert.includeDeepMembers([{e:5}, {f:6}], [{g:7}, {h:8}] as any, "blah");
        }, "blah: expected [{e:5},{f:6}] to include deep members [{g:7},{h:8}]");

        err(function() {
            assert.includeDeepMembers([{e:5}, {f:6}], [{e:5}, {f:6}, {z:0}]);
        }, "expected [{e:5},{f:6}] to include deep members [{e:5},{f:6},{z:0}]");
    });
    ...
    it("notIncludeDeepMembers", function() {
        ...
        }, "blah: not expected [{a:1},{b:2},{c:3}] to include deep members [{b:2},{a:1}]");
    });
    ...
    it("includeOrderedMembers", function() {
        ...
        }, "blah: expected [1,2,3] to start with members [2,1]");
    });
    ...
    it("notIncludeOrderedMembers", function() {
        ...
        }, "blah: not expected [1,2,3] to start with members [1,2]");
    });
    ...
    it("includeDeepOrderedMembers", function() {
        ...
        }, "blah: expected [{a:1},{b:2},{c:3}] to start with deep members [{b:2},{a:1}]");
    });
    ...
    it("notIncludeDeepOrderedMembers", function() {
        ...
        }, "blah: not expected [{a:1},{b:2},{c:3}] to start with deep members [{a:1},{b:2}]");
    });
    ...
    it("above", function() {
        ...
        }, "blah: expected null to be a number or date");
    ...
    it("above (dates)", function() {
        ...
        }, "blah: expected [Date:\"" + oneSecondAgo.toISOString() + "\"] to be above [Date:\"" + now.toISOString() + "\"]");

        err(function() {
            assert.isAbove(now, now, "blah");
        }, "blah: expected [Date:\"" + now.toISOString() + "\"] to be above [Date:\"" + now.toISOString() + "\"]");
        err(function() {
        ...
        }, "blah: expected null to be a date");

        err(function() {
            assert.isAbove(now, 1 as any, "blah");
        }, "blah: expected 1 to be a date");

        err(function() {
            assert.isAbove(1, now as any, "blah");
        }, "blah: expected [Date:\"" + now.toISOString() + "\"] to be a number");
    });
    ...
    it("atLeast (dates)", function() {
        ...
        }, "blah: expected [Date:\"" + now.toISOString() + "\"] to be at least [Date:\"" + oneSecondAfter.toISOString() + "\"]");
    ...
    it("below (dates)", function() {
        ...
        }, "blah: expected [Date:\"" + now.toISOString() + "\"] to be below [Date:\"" + oneSecondAgo.toISOString() + "\"]");

        err(function() {
            assert.isBelow(now, now);
        }, "expected [Date:\"" + now.toISOString() + "\"] to be below [Date:\"" + now.toISOString() + "\"]");
    ...
    it("atMost (dates)", function() {
        ...
        }, "blah: expected [Date:\"" + oneSecondAfter.toISOString() + "\"] to be at most [Date:\"" + now.toISOString() + "\"]");
